            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <img src="/uploads/{{$user->avatar}}" alt="" width="200" class="img-responsive img-src">
                            ...
                            <input type="file"
                                   ...
                                   accept=".jpg, .jpeg, .png"
                                   name="avatar"
                                   onchange="$('.img-src').attr ('src',this.value)">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea id="" cols="30" rows="10" class="form-control" name="description">{{$user->description}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
