                ...
                <div class="col-md-8">
                    <article class="post">
                        ...
                        <div class="post-content">
							...
							<span
                                    class="social-share-title pull-left text-capitalize">By Petro On {{$post->getDate()}}</span>
                    ...
                    <div class="related-post-carousel">
                        ...
                        <div class="related-heading">
                            <h4>Тебе может также понравиться</h4>
                        </div>
                        <div class="items">
                    ...
                    <div class="leave-comment"><!--leave comment-->
                        ...
                        <form class="form-horizontal contact-form" role="form" method="post" action="/comment">
                            ...
                            <button class="btn send-btn">Публиковать комментарий</button>
                        </form>
